...
<body id="top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarmain">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item"><a class="nav-link btn-outline-red mr-lg-2" href="{{ route('login') }}"><i
                                    class="icofont-lock"></i> Sign In</a></li>
                        @if (get_option('allow_singup') == 'yes')
                            <li class="nav-item"><a class="nav-link btn-signup mr-lg-2"
                                    href="{{ route('register') }}"><i class="icofont-ui-user"></i> Sign Up</a></li>
                        @endif
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle btn-outline-red" id="languageSelector" href="#"
                                role="button" data-bs-toggle="dropdown" aria-expanded="false"><i
                                    class="icofont-globe"></i>
                                {{ session('language') == '' ? get_option('language') : session('language') }} <i
        ...
        <div class="cookie-consent" id="cookie-consent-box">
            <div class="container">
                ...
                <button type="button" class="btn btn-primary btn-sm" id="cookie-accept-btn">
                    {{ _lang('Accept') }}</button>
                <a class="btn btn-info btn-sm" href="{{ url('/' . get_option('gdpr_privacy_policy_page')) }}"
                    target="_blank">{{ _lang('Learn More') }}</a>
            </div>
        </div>
    @endif
                ...
                <div class="col-lg-8 mr-auto col-sm-12">
                    <div class="widget mb-5 mb-lg-0">
                        ...
                        <ul class="list-inline footer-socials mt-4">
                            <li class="list-inline-item"><a href="{{ get_option('facebook_link') }}"><i
                                        class="icofont-facebook"></i></a></li>
                            <li class="list-inline-item"><a href="{{ get_option('twitter_link') }}"><i
                                        class="icofont-twitter"></i></a></li>
                            <li class="list-inline-item"><a href="{{ get_option('linkedin_link') }}"><i
    ...
    <!-- Main jQuery -->
    <script src="{{ asset('/theme/plugins/jquery/jquery-3.6.0.min.js') }}"></script>
    <!-- Bootstrap 4.3.2 -->
