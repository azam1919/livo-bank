    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-md-center"
                href="{{ route('dashboard.index') }}">{{ get_option('site_title', config('app.name')) }}</a>
                ...
                <li class="nav-item dropdown animate-dropdown">
                    <a class="nav-link dropdown-toggle" id="userDropdown" href="#" role="button"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                            class="icofont-ui-user"></i></a>
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="{{ route('profile.index') }}"><i class="icofont-ui-user"></i>
                            {{ _lang('Profile Overview') }}</a>
                        <a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="icofont-ui-edit"></i>
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"><i class="icofont-exit"></i>
                            {{ _lang('Logout') }}</a>
                    </div>
                </li>
            </ul>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-light" id="sidenavAccordion">
                ...
                <div class="sidebar-user">
                    <a href="javascript: void(0);">
                        <img src="{{ profile_picture(Auth::user()->profile_picture) }}" alt="user-image"
