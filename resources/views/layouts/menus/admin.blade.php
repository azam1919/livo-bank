...
<!-- M Arslan Starts -->
<!-- <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#news" aria-expanded="false" aria-controls="collapseLayouts">
	<div class="sb-nav-link-icon"><i class="icofont-news"></i></div>
	{{ _lang('News') }}
	<div class="sb-sidenav-collapse-arrow"><i class="icofont-rounded-down"></i></div>
</a>
<div class="collapse" id="news" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
	<nav class="sb-sidenav-menu-nested nav">
		<a class="nav-link" href="{{ route('reports.transactions_report') }}">{{ _lang('Add News') }}</a>
		<a class="nav-link" href="{{ route('reports.loan_report') }}">{{ _lang('All News') }}</a>
	</nav>
</div> -->
