        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    ...
                    <a class="btn btn-primary btn-sm ml-auto" href="{{ route('news.create') }}"><i
                                ...
                                <tr data-id="row_{{ $news->id }}">
                                    ...
                                    <td class="text-center">
                                        <span class="dropdown">
                                            ...
                                            <form action="{{ action('NewsController@destroy', $news['id']) }}"
                                                method="post">
                                                {{ csrf_field() }}
                                                <input name="_method" type="hidden" value="DELETE">

                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a href="{{ action('NewsController@edit', $news['id']) }}"
