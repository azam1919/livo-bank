 ...
 @section('content')
     ...
     <div class="px-2 pt-3 text-center shadow " style="height: 190px">
         ...
         <div class="row">
             <div class="col-4 sm-top" style="top:22px; cursor: pointer;">
                 ...
                 <div class="card-body" style="border-left: 10px solid #6574cd;">
                     ...
                     <div class="d-flex" style="justify-content: space-between;">
                         ...
                         @foreach ($account_balance as $currency)
                             <h6 class="pt-1" id="balance" style="cursor: pointer;">
    ...
    <tr>
                                                              ...
                                                              <td>{!! $loan->next_payment->repayment_date >= date('Y-m-d')
                                                                  ? xss_clean(show_status(_lang('Upcoming'), 'success'))
                                                                  : xss_clean(show_status(_lang('Due'), 'danger')) !!}</td>
