...
if (!function_exists('next_account_number')) {
...
if (!function_exists('increment_account_number')) {
	function increment_account_number($default = '')
	{
		$account_number = (int) get_option('next_account_number', date('Y') . '1001');
		$account_number = $default == '' ? $account_number + 1 : $default;
